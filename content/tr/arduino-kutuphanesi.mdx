...
<Callout type="warning">
  <strong>UYARI</strong>
  <div>
    OTA fonksiyonlarını kullanacaksanız PxServ Arduino kütüphanesinin **1.3.0
    veya daha yeni** bir sürümü yüklü olmalıdır.
  </div>
</Callout>
...
Detaylı OTA akışı, firmware hazırlama ve Arduino IDE üzerinden `.bin` dosyası oluşturma adımları için bkz: [OTA Özelliği](/tr/ota-ozelligi/)
