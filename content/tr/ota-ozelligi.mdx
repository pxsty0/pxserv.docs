...
<Callout type="warning">
  <strong>Gereksinim</strong>
  <div>
    OTA özelliğini kullanabilmek için PxServ Arduino kütüphanesinin{" "}
    <b>1.3.0 veya daha yeni</b> bir sürümü yüklü olmalıdır.
  </div>
</Callout>
...
<Callout type="error">
  <strong>ESP8266 donanım sınırları</strong>
  <div>
    ESP8266 cihazlarda OTA desteği, çipin donanımsal kısıtlamaları nedeniyle
    ESP32 kadar kararlı olmayabilir. Yeterli flash ve RAM kapasitesine sahip
    kartlar tercih edin; firmware boyutu büyüdükçe güncelleme kararlılığı
    düşebilir.
  </div>
</Callout>
...
![PxServ OTA paneli genel görünüm](/images/tr/ota-panel.png)
...
<Callout type="error">
  <strong>Kritik OTA kuralı</strong>
  <div>
    Yeni firmware içinde de <code>setDeviceFirmwareVersion()</code> ve{" "}
    <code>checkOtaFirmware()</code> akışını koruyun. OTA kodunu kaldırırsanız
    cihaz bu sürüme geçebilir ancak sonraki uzaktan güncellemeleri alamaz;
    yeniden USB/seri port müdahalesi gerekir.
  </div>
</Callout>
...
![Arduino IDE derlenmiş dosyayı dışa aktarma menüsü](/images/tr/export-binary.png)

![Arduino IDE Export Compiled Binary ayrıntıları](/images/shared/export-binary-details.png)

![Arduino IDE ile oluşturulan .bin firmware dosyası](/images/tr/firmware-file.png)
...
<Callout type="warning">
  <strong>Doğru firmware dosyasını seçin</strong>
  <div>
    ESP32 çıktısında bootloader veya partition dosyaları da bulunabilir. OTA
    için genellikle yalnızca <code>proje-adi.ino.bin</code> biçimindeki ana
    firmware dosyasını yüklemelisiniz.
  </div>
</Callout>
...
Detaylı Arduino kullanımı için bkz: [Arduino Kütüphanesi](/tr/arduino-kutuphanesi/)
