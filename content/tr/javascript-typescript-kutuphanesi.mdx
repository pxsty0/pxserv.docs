...
<Callout type="warning">
  <strong>API anahtarı güvenliği</strong>
  <div>
    API anahtarınızı istemci tarafında herkese açık şekilde kullanmayın.
    Tarayıcı tabanlı projelerde anahtarı korumak için istekleri kendi backend
    servisiniz üzerinden yönlendirmeniz önerilir.
  </div>
</Callout>
