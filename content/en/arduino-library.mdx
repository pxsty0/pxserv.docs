...
<Callout type="warning">
  ...
  <div>
    If you want to use OTA functions, install <b>version 1.3.0 or newer</b> of
    the PxServ Arduino library.
  </div>
</Callout>
...
For the full OTA flow, firmware preparation, and generating `.bin` files from Arduino IDE, see: [OTA Feature](/en/ota-feature/)
